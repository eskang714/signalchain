...
Desktop LLM chat application. Supports Claude API, Ollama, and local GGUF models.
...
├── providers/       # Claude API, Ollama, Local GGUF
├── modules/         # Two-tier plugin system
│   ├── global/      # App-maintained: conversation_history, file_system, etc.
